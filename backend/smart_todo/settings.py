...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='smart_todo'),
...
CELERY_BEAT_SCHEDULE = {
    'mark-overdue-tasks': {
        ...
        'schedule': 30.0,  # Every 30 secs - check for overdue tasks
    },
    'send-deadline-reminders': {
        'task': 'tasks.tasks.send_deadline_reminders',
        'schedule': 3600.0,  # Every hour - send reminders
    },
    'cleanup-old-tasks': {
        'task': 'tasks.tasks.cleanup_old_tasks',
        'schedule': 86400.0,  # Daily - clean up old tasks
    },
    ...
    'send-weekly-summary': {
        'task': 'tasks.tasks.send_weekly_summary',
        'schedule': crontab(day_of_week=0, hour=10, minute=0),  # Sunday at 10 AM
    },
    'process-recurring-tasks': {
        'task': 'tasks.tasks.process_recurring_tasks',
